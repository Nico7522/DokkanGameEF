...
namespace DokkanGameEF.Migrations
{
    ...
    [Migration("20231103153525_changementIsRequired")]
    partial class changementIsRequired
    {
            ...
            modelBuilder.Entity("DokkanGameEF.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Nicolas",
                            LastName = "D'Addabbo",
                            PlayerPassword = new byte[] { 116, 181, 38, 176, 80, 87, 130, 152, 168, 205, 107, 30, 165, 90, 68, 38, 115, 251, 149, 107, 165, 235, 251, 87, 21, 184, 42, 67, 218, 233, 186, 60, 232, 135, 255, 130, 28, 169, 48, 43, 107, 208, 6, 7, 32, 238, 225, 235, 207, 50, 228, 209, 42, 70, 139, 163, 249, 200, 22, 71, 220, 33, 12, 125 },
                            Pseudo = "Nico75"
                        });
                });
