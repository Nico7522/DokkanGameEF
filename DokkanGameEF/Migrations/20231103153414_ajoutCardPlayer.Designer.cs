...
namespace DokkanGameEF.Migrations
{
    ...
    [Migration("20231103153414_ajoutCardPlayer")]
    partial class ajoutCardPlayer
    {
            ...
            modelBuilder.Entity("DokkanGameEF.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Nicolas",
                            LastName = "D'Addabbo",
                            PlayerPassword = new byte[] { 249, 253, 73, 249, 129, 174, 73, 236, 167, 244, 116, 71, 213, 193, 113, 232, 205, 147, 179, 18, 29, 114, 226, 130, 36, 66, 10, 139, 213, 99, 234, 112, 73, 119, 74, 178, 40, 115, 103, 110, 46, 64, 229, 213, 251, 179, 38, 15, 134, 26, 218, 87, 224, 7, 249, 135, 221, 162, 11, 234, 64, 132, 65, 99 },
                            Pseudo = "Nico75"
                        });
                });
