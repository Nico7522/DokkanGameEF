...
namespace DokkanGameEF.Migrations
{
    ...
    [Migration("20231103151149_ajoutPlayer")]
    partial class ajoutPlayer
    {
            ...
            modelBuilder.Entity("DokkanGameEF.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Nicolas",
                            LastName = "D'Addabbo",
                            PlayerPassword = new byte[] { 149, 12, 113, 35, 58, 180, 78, 163, 84, 199, 37, 167, 137, 196, 161, 203, 176, 34, 86, 176, 173, 57, 110, 26, 161, 148, 85, 247, 65, 154, 83, 49, 88, 107, 180, 39, 76, 100, 161, 198, 182, 48, 163, 214, 177, 63, 6, 34, 106, 247, 219, 139, 133, 213, 219, 241, 255, 79, 246, 210, 181, 27, 71, 148 },
                            Pseudo = "Nico75"
                        });
                });
